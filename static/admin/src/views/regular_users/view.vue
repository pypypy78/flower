		...
		<el-row class="row_ce"> 
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="联系方式" prop="contact_information">
												<el-input id="contact_information" v-model="form_sub['contact_information']" placeholder="请输入联系方式"
							  v-if="user_group === '管理员' || (form_sub['regular_users_id'] && $check_field('set','contact_information')) || (!form_sub['regular_users_id'] && $check_field('add','contact_information'))"></el-input>
