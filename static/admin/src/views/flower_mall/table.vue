	...
	<el-row class="rows row2">
		...
		<el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap search_btns">
				...
				<el-col :xs="24" :sm="10" :lg="8" class="search_btn_1 search_btn_wrap_1 btns">
						...
						<el-button v-if="user_group == '管理员' || $check_action('/flower_mall/table','add') || $check_action('/flower_mall/view','add')" @click="$router.push('./view?')">添加</el-button>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column fixed="right" label="操作" min-width="200" v-if="user_group == '管理员' || $check_action('/flower_mall/table','set') || $check_action('/flower_mall/view','set') || $check_action('/flower_mall/view','get') || $check_action('//table','add') || $check_action('//view','add')" >
				...
				<template slot-scope="scope">
					...
					v-if="user_group == '管理员' || $check_action('/flower_mall/table','set') || $check_action('/flower_mall/view','set') || $check_action('/flower_mall/view','get')"
						...
						<router-link v-if="user_group == '管理员' || $check_comment('/flower_mall/table')" class="e-button e-button--small is-plain el-button--primary"
