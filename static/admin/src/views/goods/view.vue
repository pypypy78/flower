		...
		<el-form ref="form" :model="form" status-icon label-width="70px">
			...
			<el-col :xs="24" :sm="24" :lg="24" v-show="!form.source_table" style="text-align: center;" class="el_form_btn_warp">
				...
				<el-button @click="cancel()">取消</el-button>
					...
					<!-- 鲜花商城 -->
			<diy_flower_mall v-if="form.source_table === 'flower_mall'" :query="{flower_mall_id:form.source_id}" :form_goods="form" :func_check="checkForm" :func_submit="submit" ></diy_flower_mall>
...
<script>
	import mixin from "../../mixins/page.js";
			import diy_flower_mall from "../../components/diy/diy_flower_mall.vue";
