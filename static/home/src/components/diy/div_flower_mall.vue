<template>
	<div class="diy_details_box diy_div_flower_mall">
		<div class="warp diy_warp">
			...
			<div class="details_btn_wrap">
																<button class="btn btn-primary details_btn" v-if="$check_action('/flower_mall/details','set')" @click="change_praise()" ><span>点赞</span></button>
																<button class="btn btn-primary details_btn" v-if="$check_action('/flower_mall/details','set')" @click="change_collect()" ><span>收藏</span></button>
											</div>
						<!-- 富文本 -->
...
<script>
	...
	export default {
		...
		methods: {
			...
			change_praise(obj) {
				...
				var query = {
					...
					source_field: "flower_mall_id",
					source_id: this.obj["flower_mall_id"],
					user_id
				};
              ...
              var praise_len = _this.praiseLen;
							this.$post('~/api/flower_mall/set?flower_mall_id=' + _this.obj["flower_mall_id"], {
								praise_len
							}, (res) => {
								if(res.result){
      ...
      check_collect() {
        var user_id = this.$store.state.user.user_id;
        var flower_mall_id = this.obj.flower_mall_id;
        this.$get('~/api/collect/count?', {
          user_id,
          source_table: "flower_mall",
          source_field: "flower_mall_id",
          source_id: flower_mall_id
        }, (res) => {
