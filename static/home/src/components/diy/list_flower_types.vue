<template>
	<div class="diy_home diy_list diy_flower_types" id="diy_flower_types_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/flower_types/details?flower_types_id=' + o['flower_types_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/flower_types/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/flower_types/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
		...
		<!-- 轮播 -->
		 ...
		 <div class="carousel ins_s">
                ...
                <div  v-for="(o, i) in  list" :key="i" class="slide" >
                    ...
                    <router-link :to="'/flower_types/details?flower_types_id=' + o['flower_types_id']" class="lis_cont">
                        <div class="diy_list_img_box" v-if="imgList.length" >
    					        <div class="diy_row" v-for="(item, index) in imgList" :key="item + index" v-show="$check_field('get',item.name,'/flower_types/details') && +item.is_img_list">
    						<div class="diy_title diy_list_img_title">
...
<script>
	export default {
		...
		methods: {
			...
			to_detail(v){
				this.$router.push("/flower_types/details?flower_types_id="+v.flower_types_id)
			},
