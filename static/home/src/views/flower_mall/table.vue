				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							<!-- 鲜花商城 -->
							<div><span>鲜花商城</span></div>
							<table_flower_mall v-if="$check_action('/flower_mall/table','get')"></table_flower_mall>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import table_flower_mall from "../../components/diy/table_flower_mall.vue";
	export default {
		data() {
			return {
			};
