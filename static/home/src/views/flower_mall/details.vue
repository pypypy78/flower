<template>
	<div class="diy_details page_flower_mall" id="flower_mall_details">
		...
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_flower_mall'>
							<div_flower_mall :obj="obj"></div_flower_mall>
...
<script>
	import div_flower_mall from "@/components/diy/div_flower_mall.vue";
	...
	export default {
		...
		methods:{
			...
			add_hits(obj) {
				obj["hits"] = obj["hits"] + 1;
				var hits = obj["hits"];
				this.$post('~/api/flower_mall/set?flower_mall_id=' + obj["flower_mall_id"], {
					hits
				}, (res) => {
					if(res.result){
			...
			get_obj_after(json) {
				...
				if (json && json.result && json.result.obj) {
					...
					this.form_comment.source_id = this.obj.flower_mall_id;
				}
			},
			/**
			 * 初始化收藏状态
