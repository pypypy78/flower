				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							...
							<view_storage_information v-if="$check_action('/storage_information/view','get')"></view_storage_information>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import view_storage_information from "../../components/diy/view_storage_information.vue";
	export default {
		data() {
			return {
			};
