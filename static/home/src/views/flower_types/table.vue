				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							<!-- 鲜花种类 -->
							<div><span>鲜花种类</span></div>
							<table_flower_types v-if="$check_action('/flower_types/table','get')"></table_flower_types>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import table_flower_types from "../../components/diy/table_flower_types.vue";
	export default {
		data() {
			return {
			};
